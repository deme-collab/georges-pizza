...
function GeorgesPizza() {
  ...
  const pizzaMenu = {
    classic: [
      ...
      { name: 'Steak', desc: 'Sliced Steak', prices: { small: 14, large: 18, xlarge: 20 } },
    ],
    specialty: [
      ...
      { name: 'Grilled Chicken', desc: 'Grilled Marinated Chicken Breast', prices: { small: 14, large: 18, xlarge: 20 } },
      { name: 'BBQ Chicken', desc: 'Grilled Chicken with BBQ Sauce', prices: { small: 14, large: 18, xlarge: 20 } },
      { name: 'Buffalo Chicken', desc: 'Spicy Buffalo Chicken with Bleu Cheese Drizzle', prices: { small: 14, large: 18, xlarge: 20 } },
      { name: 'Meat Lover', desc: 'Pepperoni, Sausage, Ham, Bacon & Ground Beef', prices: { small: 14, large: 18, xlarge: 20 }, hasPepperoniChoice: true },
    ],
  ...
  const whitePizzaMenu = {
    items: [
      ...
      { name: 'Spinach', desc: 'Fresh Spinach on Garlic Base', prices: { small: 12, large: 14, xlarge: 17 } },
      { name: 'Broccoli', desc: 'Fresh Broccoli on Garlic Base', prices: { small: 12, large: 14, xlarge: 17 } },
      { name: 'Vegetarian', desc: 'Broccoli, Green Peppers, Onions, Tomatoes & Mushrooms', prices: { small: 14, large: 18, xlarge: 20 } },
      { name: 'Ricotta & Mozzarella', desc: 'Creamy Ricotta & Mozzarella Blend', prices: { small: 11, large: 14, xlarge: 17 } },
      { name: 'Greek', desc: 'Feta, Mozzarella, Spinach, Tomatoes, Olives & Oregano', prices: { small: 14, large: 18, xlarge: 20 } },
      { name: 'Hawaiian', desc: 'Sweet Pineapple & Sliced Ham', prices: { small: 14, large: 18, xlarge: 20 } },
    ],
  };

  const steaksMenu = {
    beef: [
      { name: 'Steak', desc: 'Plain steak on a fresh roll', price: 10, hasSteakMods: true },
      { name: 'Cheese Steak', desc: 'With your choice of cheese', price: 11, hasSteakMods: true },
    ...
    chicken: [
      { name: 'Chicken Steak', desc: 'Plain chicken on a fresh roll', price: 11, hasSteakMods: true },
  ...
  const stromboliMenu = {
    items: [
      { name: 'Steak Cheese & Sauce Stromboli', prices: { small: 14, large: 16 }, hasStromboliMods: true },
      { name: 'Buffalo Chicken Stromboli', prices: { small: 14, large: 16 }, hasStromboliMods: true },
      { name: 'Special Steak Stromboli', desc: 'Cheese, Mushrooms, Sauce, Fried Onions, Green Peppers & Pepperoni', prices: { small: 16, large: 19 }, hasStromboliMods: true },
      { name: 'Cheese & Sauce Stromboli', prices: { small: 12, large: 14 }, hasStromboliMods: true },
      { name: 'Ground Beef Cheese & Sauce Stromboli', prices: { small: 14, large: 16 }, hasStromboliMods: true },
      { name: 'Sausage Cheese & Sauce Stromboli', prices: { small: 14, large: 16 }, hasStromboliMods: true },
      { name: 'Italian Cappicola Genoa Stromboli', prices: { small: 14, large: 16 }, hasStromboliMods: true },
      { name: 'Pepperoni Cheese & Sauce Stromboli', prices: { small: 14, large: 16 }, hasStromboliMods: true },
      { name: 'Ham & Cheese Stromboli', prices: { small: 14, large: 16 }, hasStromboliMods: true },
      { name: 'Vegetarian Stromboli', desc: 'Onions, Green Peppers, Cheese, Sauce & Mushrooms', prices: { small: 14, large: 16 }, hasStromboliMods: true },
      { name: 'Grilled Chicken Cheese & Sauce Stromboli', prices: { small: 14, large: 16 }, hasStromboliMods: true },
      { name: 'Chicken Steak Cheese & Sauce Stromboli', prices: { small: 14, large: 16 }, hasStromboliMods: true },
    ],
        ...
        <div style={{ background: 'white', border: '2px solid #C41E3A', padding: 16, marginTop: 16 }}>
          ...
          {!cart.some(i => i.isMealDeal) && !cart.some(i => Array.isArray(i.mods) && i.mods.includes('Lunch Special')) && subtotal > 0 && subtotal < 45 && (
            <div style={{ fontSize: 12, color: '#555', paddingTop: 8, fontStyle: 'italic' }}>
              💡 Add ${(45 - subtotal).toFixed(2)} more for 1 FREE 2L Soda! <span style={{ opacity: 0.7 }}>(excludes specials & deals)</span>
            </div>
          )}
